...
<div class="login-box">
  <div class="login-logo">
    <a href="<?= base_url()."appnet/super_admin"?>"><img src="<?php echo base_url()."public/web/imagenes/logo.svg" ?>" height="100" alt=""></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Appnet Login</p>

    <form action="<?php echo base_url()."/super_admin/login/" ?>" method="post">
      ...
      <div class="row">
        ...
        <br><br>
        <div class="col-xs-12 ">
          <a href="<?= base_url()."super_admin/login/crear_cuenta"?>" class="btn btn-success btn-block  ">Crear Cuenta</a>
        </div>
        <br><br>
        </form>
        <div class="col-xs-12 ">
          <a href="<?= base_url()."super_admin/login/recuperar_contrasena"?>" class="btn btn-warning btn-block  ">Recuperar Contraseña</a>
        </div>
        <!-- /.col -->
      </div>
